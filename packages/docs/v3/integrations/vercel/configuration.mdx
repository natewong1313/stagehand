...
<Tabs>
	<Tab title="npm">
	```bash
	npm install @natewong1313/stagehand @browserbasehq/sdk playwright zod
	```
	</Tab>

	<Tab title="pnpm">
	```bash
	pnpm add @natewong1313/stagehand @browserbasehq/sdk playwright zod
	```
	</Tab>

	<Tab title="yarn">
	```bash
	yarn add @natewong1313/stagehand @browserbasehq/sdk playwright zod
	```
	</Tab>
</Tabs>
